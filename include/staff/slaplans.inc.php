...
<div style="float:right;text-align:right;padding-top:5px;padding-right:5px;">
 <b><a href="slas.php?a=add" class="btn btn-default pull-right">Add New SLA Plan</a></b></div>
<div class="clear"></div>
...
<p class="centered" id="actions">
    ...
    <input class="button btn btn-default" type="submit" name="delete" value="Delete" >
</p>
<?php
endif;
?>
