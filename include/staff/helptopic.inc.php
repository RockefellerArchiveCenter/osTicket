    ...
    <tbody>
        <tr>
            ...
            <td class="form-group form-inline has-error">
                ...
                <?php if($errors['topic']) echo '<span class="alert alert-danger">' .$errors['topic']. '</span>'; ?>
            </td>
        </tr>
        <tr>
            <td width="180" class="required">
       ...
       <tr>
           ...
           <select class="form-control" name="form_id">
               ...
               <p class="help-block">Extra information for tickets associated with this help topic</p>
        ...
        <tr>
            ...
            <td class="form-group form-inline">
                ...
                <label>Disable new ticket auto-response for this topic (Overrides Dept. settings).</label>
            </td>
        </tr>
        <tr>
            <th colspan="2">
...
<p class="centered">
    ...
    <input class="btn btn-danger" type="button" name="cancel" value="Cancel" onclick='window.location.href="helptopics.php"'>
</p>
</form>
